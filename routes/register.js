...
router.post("/parent", upload.single('image'),(req, res,next) => {
    ...
    parent = new Parent(req.body);
      ...
      /*   var name = req.body.name;
        ...
        var line1 = req.body.address[0][line1];
        var line2 = req.body.address[0][line2];
        var city = req.body.address[0][town_village];
        var province = req.body.address[0][province];
        var pincode = req.body.address[0][pincode];
        var state = req.body.address[0][state]; */
        ...
        req.checkBody('spouse',"Spouse field is not valid").isAlpha();
        req.checkBody('children[0]',"Children field is required").notEmpty();
        req.checkBody('children[0]',"Children field is not valid").isNumeric();
        ...
        /* req.checkBody('address[0][line1]',"Line 1 field is not valid").isAlphanumeric(); */
        req.checkBody('address[0][line2]',"Line 2 field is required").notEmpty();
      /*   req.checkBody('address[0][line2]',"Line 2 field is not valid").isAlphanumeric(); */
        req.checkBody('address[0][town_village]',"City field is required").notEmpty();
        req.checkBody('address[0][town_village]',"City is not valid").isAlpha();
        req.checkBody('address[0][province]',"Province field is required").notEmpty();
        req.checkBody('address[0][province]',"Province is not valid").isAlpha();
...
router.post("/child", upload.single('image'),(req, res) => {
    var formData = req.body;
        ...
        req.checkBody('aadharno',"Aadharno field is not valid ").isNumeric().isLength({min : 12,max : 12});
        req.checkBody('address[0][line1]',"Line 1 field is required").notEmpty();
        /* req.checkBody('address[0][line1]',"Line 1 field is not valid").isString(); */
        req.checkBody('address[0][line2]',"Line 2 field is required").notEmpty();
        /* req.checkBody('address[0][line2]',"Line 2 field is not valid").isString(); */
        req.checkBody('address[0][town_village]',"City field is required").notEmpty();
        req.checkBody('address[0][town_village]',"City is not valid").isAlpha();
        req.checkBody('address[0][province]',"Province field is required").notEmpty();
        req.checkBody('address[0][province]',"Province is not valid").isAlpha();
        ...
        req.checkBody('address[0][pincode]',"Pincode is not valid").isNumeric();
        req.checkBody('address[0][state]',"State field is required").notEmpty();
        req.checkBody('address[0][state]',"State is not valid").isAlpha();
